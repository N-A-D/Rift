...
1. Creating entities in a system transformation with the `rift::EntityManager::create_entity` member and assigning the same components required by the transformation is not recommended as it would increase execution time. 
